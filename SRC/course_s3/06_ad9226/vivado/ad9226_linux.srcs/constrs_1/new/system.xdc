...
set_property PACKAGE_PIN V12 [get_ports {ad1_d[11]}]
set_property PACKAGE_PIN W12 [get_ports {ad1_clk}]
set_property PACKAGE_PIN U12 [get_ports {ad1_d[9]}]
set_property PACKAGE_PIN U11 [get_ports {ad1_d[10]}]
set_property PACKAGE_PIN U9 [get_ports {ad1_d[7]}]
set_property PACKAGE_PIN U10 [get_ports {ad1_d[8]}]
set_property PACKAGE_PIN T6 [get_ports {ad1_d[5]}]
set_property PACKAGE_PIN R6 [get_ports {ad1_d[6]}]
set_property PACKAGE_PIN U5 [get_ports {ad1_d[3]}]
set_property PACKAGE_PIN U6 [get_ports {ad1_d[4]}]
set_property PACKAGE_PIN U4 [get_ports {ad1_d[1]}]
set_property PACKAGE_PIN T4 [get_ports {ad1_d[2]}]
set_property PACKAGE_PIN W10 [get_ports {ad1_otr}]
set_property PACKAGE_PIN W11 [get_ports {ad1_d[0]}]
set_property PACKAGE_PIN Y10 [get_ports {ad2_d[11]}]
set_property PACKAGE_PIN Y11 [get_ports {ad2_clk}]
set_property PACKAGE_PIN W8 [get_ports {ad2_d[9]}]
set_property PACKAGE_PIN V8 [get_ports {ad2_d[10]}]
set_property PACKAGE_PIN AA6 [get_ports {ad2_d[7]}]
set_property PACKAGE_PIN AA7 [get_ports {ad2_d[8]}]
set_property PACKAGE_PIN AA11 [get_ports {ad2_d[5]}]
set_property PACKAGE_PIN AB11 [get_ports {ad2_d[6]}]
set_property PACKAGE_PIN AB4 [get_ports {ad2_d[3]}]
set_property PACKAGE_PIN AB5 [get_ports {ad2_d[4]}]
set_property PACKAGE_PIN AB1 [get_ports {ad2_d[1]}]
set_property PACKAGE_PIN AB2 [get_ports {ad2_d[2]}]
set_property PACKAGE_PIN Y4 [get_ports {ad2_otr}]
set_property PACKAGE_PIN AA4 [get_ports {ad2_d[0]}]
